...
public class SortearPessoa {
	public static void main(String[] args) {
      ...
      //Lista para aguarda os nomes digitados:
      ArrayList<String>  nomes = new ArrayList<>();
      String nome; //Variavel para aguarda nome digitado:
      ...
      if (nome.isEmpty() ) {
    	  ...
    	  String nomeSorteados = nomes.get(indiceSorteado);
    	  
    	  //exibe o nome sorteadoo:
    	  System.out.println("A pessoa sorteada foi: " + nomeSorteados);
